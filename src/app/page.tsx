...
const services = [
  {
    ...
    title: 'Bootverhuur',
    description: 'Dag- en weekverhuur van onze gevarieerde vloot. Van compacte sloepen tot ruime motorjachten — voor elk gezelschap de juiste boot.',
    href: '/vloot',
    cta: 'Bekijk vloot',
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <circle cx="24" cy="24" r="4" fill="#b46a3a" stroke="none" />
      </svg>
    ),
    title: 'Onderhoud & Reparatie',
    description: 'Jaarlijks onderhoud, winterklaar maken, motorservice en reparaties. Wij zorgen dat uw boot altijd betrouwbaar op het water ligt.',
    href: '/diensten',
  ...
  },
  {
    ...
    description: 'Overdekte en buitenstalling voor uw eigen boot. Veilig opbergen in de wintermaanden, met eventuele onderhoudsbeurten ter plaatse.',
    href: '/diensten',
    ...
    <>
      ...
      <section className="relative min-h-[92vh] bg-navy flex flex-col items-center justify-center text-center px-4 overflow-hidden">
        ...
        >
          ...
          <path d="M0 480 Q 200 460, 400 482 T 800 478 T 1200 480" stroke="#e9dfc9" strokeOpacity="0.18" strokeWidth="2">
            <animate
              attributeName="d"
              dur="7s"
              begin="0s"
          ...
          <path d="M0 520 Q 200 500, 400 522 T 800 518 T 1200 520" stroke="#e9dfc9" strokeOpacity="0.13" strokeWidth="2">
            <animate
              attributeName="d"
              dur="9s"
              begin="-3s"
          ...
          <path d="M0 560 Q 200 540, 400 562 T 800 558 T 1200 560" stroke="#e9dfc9" strokeOpacity="0.08" strokeWidth="2">
            <animate
              attributeName="d"
              dur="6s"
              begin="-1.5s"
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          {/* Boat-in-circle logo — exact proportions from original SVG thumbnail */}
          <svg
            viewBox="-130 -130 260 260"
            className="w-36 h-36 sm:w-44 sm:h-44 mb-8"
            fill="none"
            stroke="#b46a3a"
            strokeWidth="6"
            strokeLinecap="round"
          ...
          {/* Brand name — Georgia serif, large, cream + bronze, identical to original */}
          ...
          <p className="text-cream/70 text-base sm:text-lg max-w-lg leading-relaxed mb-10">
            Bootverhuur en onderhoud aan de Binnenmaas. Ontdek de rust van de
            Hoeksche Waard op het water.
          </p>
      ...
      <section className="py-20 px-4 bg-cream">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            <p className="text-bronze text-xs font-mono uppercase tracking-widest mb-3">Onze vloot</p>
            <h2 className="font-serif text-navy text-3xl sm:text-4xl mb-4">Kies uw boot</h2>
            <p className="text-ink-muted max-w-lg mx-auto">
              Van compacte dagsloep tot ruim motorjacht — elk gezelschap vindt bij ons de juiste boot.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-navy">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            <p className="text-bronze text-xs font-mono uppercase tracking-widest mb-3">Wat wij doen</p>
            <h2 className="font-serif text-cream text-3xl sm:text-4xl mb-4">Onze diensten</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                ...
                <h3 className="font-serif text-cream text-xl mb-3">{service.title}</h3>
      ...
      <section className="py-20 px-4 bg-cream">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-bronze text-xs font-mono uppercase tracking-widest mb-3">Waarom WielaardMarine</p>
              <h2 className="font-serif text-navy text-3xl sm:text-4xl mb-6">
                Varen zonder zorgen,<br />genieten met vertrouwen
              </h2>
              <p className="text-ink-muted leading-relaxed mb-6">
                WielaardMarine is al jaren dé aanlegplaats aan de Binnenmaas. Onze boten zijn goed
                onderhouden, onze tarieven transparant en onze service persoonlijk.
              </p>
              <ul className="space-y-3 text-sm">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-ink-muted">
                    <svg viewBox="0 0 20 20" className="w-5 h-5 text-bronze shrink-0 mt-0.5" fill="currentColor">
            ...
            {/* Decorative logo — large, low opacity */}
            <div className="hidden lg:flex items-center justify-center">
              <svg
                viewBox="-130 -130 260 260"
                className="w-64 h-64 text-navy opacity-10"
                fill="none"
                stroke="currentColor"
                strokeWidth="4"
                strokeLinecap="round"
              ...
              >
                ...
                <path d="M-70 30 Q -35 10, 0 30 T 70 30" />
                <line x1="0" y1="-90" x2="0" y2="-10" />
                <circle cx="0" cy="-100" r="8" fill="currentColor" stroke="none" />
                <line x1="-50" y1="-40" x2="50" y2="-40" />
              </svg>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-bronze">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-serif text-navy text-3xl sm:text-4xl mb-4">Klaar om te varen?</h2>
